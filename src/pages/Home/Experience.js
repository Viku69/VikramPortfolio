...
//               <div className='flex flex-col h-[100vh] w-[10vw] bg-black items-center p-10'>
//                   <div className="h-20 w-20 bg-black rounded-full border-2 border-white overflow-hidden ">
//                       <img src={ExperienceAvatar} alt="EducationAvatar" className=' h-22 w-22  ' />
//                   </div>
//                   <div>
...
//         id: 1,
//         role: "iOS Developer",
//         imageUrl: "https://play.google.com/store/apps/details?id=com.cashcry.android&hl=en_US",
//         company: "CashC₹y",
//     },
//     {
//         id: 2,
...
//     return (
//         <div>
//             <div className='flex flex-row gap-x-[10vw] p-5 mx-10 my-auto max-w-screen-xxl'>
//                 <div className='flex flex-col  h-[100vh] w-[10vw] bg-black items-center p-10 relative'>
...
//                     return (
//                         <div key={data.id}>
//                              <ExpCard Role={data.role} ImageUrl={data.imageUrl} />
//                         </div>
